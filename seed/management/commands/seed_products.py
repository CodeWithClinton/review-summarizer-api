...
#                 "image_url": "https://example.com/images/router.jpg",
#                 "price": 179.00,
#                 "reviews": [
...
#             if not created:
#                 self.stdout.write(f"Skipped existing product: {product.name}")
#                 continue
...
#         self.stdout.write(self.style.SUCCESS("🎉 10 products with reviews successfully seeded"))
